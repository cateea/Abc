...
namespace Abc.Pages.Quantity {
    ...
    public abstract class MeasuresPage : BasePage<IMeasureRepository, Measure, MeasureView, MeasureData> {

        protected internal MeasuresPage(IMeasureRepository r = null): base(r) {
            PageTitle = "Measures";
        }
